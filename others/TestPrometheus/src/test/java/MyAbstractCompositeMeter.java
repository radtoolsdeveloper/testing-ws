...
abstract class MyAbstractCompositeMeter<T extends Meter> extends AbstractMeter {
	...
	MyAbstractCompositeMeter(Id id) {
		super(id);
	}
	...
	T firstChild() {
		...
		// There are no child meters at the moment. Return a lazily instantiated
		// no-op meter.
	...
	/**
	 * Does nothing. New registries added to the composite are automatically
	 * reflected in each meter belonging to the composite.
	 *
	 * @param registry
